...
<div class="tile is-ancestor">
  ...
  <div class="tile is-parent">
    <div class="tile is-child box">
      ...
      <form action="process/update_category.php" method="post">
          ...
          <div class="columns" style="text-align: left;">
            <div class="column">
              ...
              <a href="delete_category.php" class="button is-light"><b><span class="icon"><i class="fa fa-minus-circle"></i></span> ลบหมวดหมู่สินค้า</b></a>
              <hr>
            </div>
          </div>
          ...
          <div class="control is-horizontal" style="margin-bottom: 30px;">
            ...
            <div class="control is-grouped">
              <p class="control is-expanded">
                <input type="text" class="input" id="category_name" name="category_name" value="<?php echo $category_name; ?>" required>
